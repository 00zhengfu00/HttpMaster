...
public class ShaderEditor extends EditText {
    ...
    private static final int COLOR_KEYWORD = 0xff66d9d0;

    private static final int COLOR_BUILTIN = 0xfff92672;
    ...
    private static final Pattern keywords = Pattern.compile(
            "\\b(attribute|const|uniform|varying|break|continue|" +
                    "do|for|while|if|else|in|out|inout|float|int|String|void|bool|true|false|" +
