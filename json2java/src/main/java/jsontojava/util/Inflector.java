    ...
    public String pluralize(Object word) {
        if(word == null) {
            ...
            if(wordStr.length() == 0) {
                ...
                Iterator i$ = this.plurals.iterator();
                ...
                do {
                    ...
                    Inflector.Rule rule = (Inflector.Rule)i$.next();
    ...
    public String singularize(Object word) {
        if(word == null) {
            ...
            if(wordStr.length() == 0) {
                ...
                Iterator i$ = this.singulars.iterator();
        ...
        if(lowerCaseAndUnderscoredWord == null) {
            ...
            if(lowerCaseAndUnderscoredWord.length() == 0) {
                ...
                if(delimiterChars != null) {
                    char[] arr$ = delimiterChars;
                    int len$ = delimiterChars.length;

                    for(int i$ = 0; i$ < len$; ++i$) {
                        char delimiterChar = arr$[i$];
        ...
        if(lowerCaseAndUnderscoredWords == null) {
            ...
            if(result.length() == 0) {
                ...
                if(removableTokens != null) {
                    String[] arr$ = removableTokens;
                    int len$ = removableTokens.length;

                    for(int i$ = 0; i$ < len$; ++i$) {
                        String removableToken = arr$[i$];
