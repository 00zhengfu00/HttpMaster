...
import jsontojava.util.IOUtils;
import jsontojava.util.Inflector;
import jsontojava.util.StringUtils;
...
//		dir.mkdirs();
	...
	for (Map.Entry<String, NewType> entry : mTypes.entrySet()) {
	    ...
	    sb.append("path + fileSeparater + className + FILE_EXTENSION_JAVA");
	   // out.putNextEntry(e);
